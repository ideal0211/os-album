package club.xyes.os.album.service.basic;
...
public interface AbstractService<Entity extends AbstractEntity> {
     ...
     */
    default <T extends Entity> void resolvePath(List<T> source) {
        source.forEach(this::resolvePath);
    }
