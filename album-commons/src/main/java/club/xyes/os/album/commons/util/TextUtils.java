package club.xyes.os.album.commons.util;
...
import club.xyes.os.album.commons.fn.GetterFunction;
import lombok.val;
...
public class TextUtils {
    ...
    public static String encodeUri(String text) {
        try {
            return URLEncoder.encode(text, ApplicationConstants.DEFAULT_CHARSET);
